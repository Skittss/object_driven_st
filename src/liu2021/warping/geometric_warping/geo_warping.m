function [warp_out, flow_out, flow_colour] = geometric_warping(content_img_path, style_img_path, img_size)
    ...
    CONTENT_IMAGE = imread(content_img_path);
    STYLE_IMAGE = imread(style_img_path);
    ...
    warp_out = output;
    flow_out = flow;
    flow_colour = uint8(flowToColor(flow));
